...
public class RobotController implements Controller {
	private static final String TAG = "Y20A, RobotController";
	
	private static final int HEAD_MOTOR_LEFTRIGHT = 0;			// 左右摇头电机
	private static final int HEAD_MOTOR_UPDOWN = 1;		    	// 上下点头电机
	private static final int HEAD_MOTOR_DIRECT_LEFT = 0;		// 左右摇头电机向左, 0:正转, 1:反转
	private static final int HEAD_MOTOR_DIRECT_RIGHT = 1;		// 左右摇头电机向右, 0:正转, 1:反转
	private static final int HEAD_MOTOR_DIRECT_UP = 0;		    // 上下点头电机向上, 0:正转, 1:反转
	private static final int HEAD_MOTOR_DIRECT_DOWN = 1;		// 上下点头电机向下, 0:正转, 1:反转
	
	public static final int DRVTYPE_BY_TIME = 0;		// 驱动类型, 0: 按时间（单位：毫秒）
	public static final int DRVTYPE_BY_DISTANCE = 1;	// 驱动类型, 1: 按距离（单位：厘米）
	private static final int MIN_SPEED = 60;	        // 电机速度最小值
	private static final int MAX_SPEED = 320;	        // 电机速度最大值
